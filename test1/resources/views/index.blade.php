...
<div class="container">
    <div class="starter-template">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="https://toiler.com.ua/files/resized/products/iphone-15-3_1.600x800.jpg" alt="iPhone 15 Pro 128GB">
                    <div class="caption">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail">
            <img src="https://brain.com.ua/static/images/prod_img/9/1/U0955691_big_1723781355.jpg" alt="Samsung Galaxy Buds3">
            <div class="caption">
                <h3>Samsung Galaxy Buds3</h3>
                <p>6899грн</p>
                <p>
                    <a href="http://test1.test/basket/1/add" class="btn btn-primary" role="button">До корзини</a>
                    <a href="http://test1.test/mobiles/galaxy_buds_3" class="btn btn-default" role="button">Докладніше</a>
                </p>
            </div>
        </div>
    </div>
